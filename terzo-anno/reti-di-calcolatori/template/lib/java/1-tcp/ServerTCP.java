...
public class ServerTCP {
    ...
    public static void main(String[] args) {
        ...
        elementi[0].setDATO1("DATO11");
        elementi[0].setDATO2("DATO21");
        elementi[0].setDATO3(1);

        elementi[1].setDATO1("DATO12");
        elementi[1].setDATO2("DATO22");
        elementi[1].setDATO3(1);

        elementi[2].setDATO1("DATO13");
        elementi[2].setDATO2("DATO23");
        elementi[2].setDATO3(1);
