...
int main(int argc, char **argv)
{
    ...
    while( gets(invioUDP.directory) ) {
        ...
        // Inserimento parola ----------------------------------------
        printf("Inserisci parola finale riga max 4 caratteri: \n");
        gets(invioUDP.parolaFinale);
        if(strlen(invioUDP.parolaFinale) !=4 ){
            printf("Errore, inserire una parola valido\n");
            continue;
        }
