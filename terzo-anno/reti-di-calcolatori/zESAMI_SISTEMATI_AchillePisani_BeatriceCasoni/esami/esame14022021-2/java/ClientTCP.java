...
public class ClientTCP {
    ...
    public static void main(String[] args) throws IOException {
        ...
        /* Variabili ------------------------------------------------------------ */
        String inputIdSeriale, newId, inputId;
        int risultato;
        ...
        while ((servizio = stdIn.readLine()) != null) {
            ...
            if (servizio.equals("1")) {
                ...
                System.out.println("Inserisci nome id seriale:");
                inputIdSeriale = stdIn.readLine();
                outSock.writeUTF(inputIdSeriale);
                
                System.out.println("Inserisci nuovo id carta:");
