            ...
            try {
                ...
                while ((servizio = inSock.readUTF()) != null) {
                    ...
                    if (servizio.equals("1")) {
                        inputTarga = inSock.readUTF();
                        //newId = inSock.readUTF();
                        risultato = 0;

                        for ( i = 0; i < 10; i++ ){
                            if (ServerTCP.t[i].getTarga().equals(inputTarga)){
                                ServerTCP.t[i].setTarga("L");
                                ServerTCP.t[i].setPatente("0");
                                ServerTCP.t[i].setTipo("L");
                                ServerTCP.t[i].setImg("L");
                                risultato = 1;
...
public class ServerTCP {
    ...
    public static void main(String[] args) {
        ...
        try (ServerSocket serverSocket = new ServerSocket(port)) {
            ...
            t[0].setTarga("AA344AA");
            t[0].setPatente("11111");
            t[0].setTipo("auto");
            t[0].setImg("AA344AA_img/");

            t[1].setTarga("CD933AA");
            t[1].setPatente("22222");
            t[1].setTipo("camper");
            t[1].setImg("CD933AA_img/");

            t[2].setTarga("BB444CM");
            t[2].setPatente("33333");
            t[2].setTipo("auto");
            t[2].setImg("BB444CM_img/");
