...
public class ClientTCP {
    ...
    public static void main(String[] args) throws IOException {
        ...
        /* Servizi fino ad EOF --------------------------------------------------- */
        System.out.println("Inserisci il servizio: 1= elimina una prenotazione, 2= scarica foto");
        while ((servizio = stdIn.readLine()) != null) {
            ...
            if (servizio.equals("1")) {
                ...
                inputTarga = stdIn.readLine();
                outSock.writeUTF(inputTarga);
            ...
            /* SCARICA FOTO ===================================================== */
                ...
                outSock.writeUTF(servizio);
                System.out.println("Inserisci targa della quale vuoi le foto: ");
                inputTarga = stdIn.readLine();
                outSock.writeUTF(inputTarga);
