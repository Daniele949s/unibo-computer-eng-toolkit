      ...
      try{ 
          try {
              ...
              while ((servizio = inSock.readUTF()) != null) {
                  ...
                  int cont = 0, numOccorrenze = 0, countCar= 0;
                  int read_bytes = 0;
                              ...
                              while ((line = br.readLine()) != null) { 
                                 ...
                                 // String [] substrings = line.split(" ");
                                  ...
                                  for ( int i = 0; i < substrings.length ; i++ ){
                                    if ( substrings[i] != String.valueOf(carattere)){
                          ...
                          for (int i = 0; i < files.length; i++) {
                              ...
                              if(!file.getName().endsWith(".txt"))
                              {
                            	  ...
                            	  for (int j = 0; j < file.getName().length(); j++) {
                            		  ...
                            		  if(Character.isAlphabetic(file.getName().charAt(i))) {
                            			  isalpha ++;
                            		  }
                            	  }
                            	  ...
                            	  if(isalpha >=1)
                            	  {
                                      ...
                                      System.out.println("nome file senza il min di car alfabetici");
                                  }
