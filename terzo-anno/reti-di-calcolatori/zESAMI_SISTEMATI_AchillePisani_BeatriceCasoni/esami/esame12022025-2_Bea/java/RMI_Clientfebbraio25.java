...
class RMI_Client {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("Inserisci il servizio richiesto: 1= elimina_parola, 2= lista_nomifile_soglia");
            while ( (service = stdIn.readLine()) != null ){
                ...
                if (service.equals("1")) {
                    ...
                    result = serverRMI.elimina_parola(nomeFile, parola); // Chiamata RMI
                ...
                /* lista_nomifile_soglia ========================================================= */
                    ...
                    System.out.println("Inserisci intero soglia delle dim file: ");
                    soglia = Integer.parseInt(stdIn.readLine());
                    
                    lista = serverRMI.lista_nomifile_soglia(nomeDirectory,soglia); // Chiamata RMI
